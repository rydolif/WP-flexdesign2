<?php
/* Template name: Головна ru*/
?>

<?php get_header(); ?>

<?php get_template_part( 'parts_ru/nav' ); ?>
	...
	<div id="fullpage">
		...
		<div class="portfolio section" id="section1">
			<a href="<?php echo get_home_url(); ?>/ru/burgery/" class="portfolio__item">
		...
		<?php get_template_part( 'parts_ru/contacts_index' ); ?>
